...
export const REDIS_STREAM_MAXLEN = {
  [REDIS_STREAMS.MARKET_TICKS_STREAM]: 50_000,
  [REDIS_STREAMS.MARKET_EVENTS_STREAM]: 25_000,
  [REDIS_STREAMS.ORDER_STREAM]: 10_000,
  [REDIS_STREAMS.ENGINE_COMMANDS_STREAM]: 10_000,
  [REDIS_STREAMS.ENGINE_DB_STREAM]: 25_000,
  [REDIS_STREAMS.ENGINE_DLQ_STREAM]: 5_000,
  [REDIS_STREAMS.USER_EVENTS_STREAM]: 10_000,
} as const;
